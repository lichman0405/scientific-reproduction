...
Covered behaviors:
  * all 23 normative object types round-trip ``to_dict()`` / ``from_dict()``;
...
def test_registry_covers_all_23_normative_types() -> None:
    assert len(m.MODEL_REGISTRY) == 23
    assert len(m.SCHEMA_NAMES) == 23
